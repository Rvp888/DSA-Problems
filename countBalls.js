...
// sum of digits of the ball's number. For example, the ball number 321 will be put 
// in the box number 3 + 2 + 1 = 6 and the ball number 10 will be put in the box number 1 + 0 = 1.
