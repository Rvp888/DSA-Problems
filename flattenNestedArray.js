...
// Explanation
// Passing a depth of n=0 will always result in the original array. This is because the smallest possible depth of 
// a subarray (0) is not less than n=0. Thus, no subarray should be flattened. 
