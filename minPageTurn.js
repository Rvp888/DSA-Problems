...
// of the book or from the back of the book. They always turn pages one at a time. When they open the book, page 1 is always 
// on the right side.
...
function minPageTurn(n, p) {

    let fromFront = Math.ceil( (p - 1)/2 );
